...
public class Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initPalette();
        initPixels();
        fillScreen(ContextCompat.getColor(Main.this, R.color.white));
        ...
        DrawerMenuItem drawerOpen = new DrawerMenuItem(R.drawable.menu_open, R.string.menu_open) {
            ...
            public void execute() {
                ...
                if ((path != null) && (path.listFiles().length > 0)) {
                    ...
                    Toast toast = Toast.makeText(Main.this, R.string.file_no_files_found, Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        };
    ...
    public void openFile(String fileName, boolean showToast) {
        ...
        try {
            ...
            Log.e("Main.openFile", "File not found");
            if (showToast) {
                Toast toast = Toast.makeText(this, R.string.file_not_found, Toast.LENGTH_LONG);
                toast.show();
            }
        } catch (IOException e) {
            Log.e("Main.openFile", "Could not open file");
            if (showToast) {
    ...
    public void saveFile(String fileName, boolean showToast) {
        if (isExternalStorageWritable()) {
            Log.e(Main.class.getName(), "External Storage is not writable");
        }
        ...
        try {
            ...
            Log.e("Main.saveFile", "File not found");
    ...
    public void screenShot(View view, String filename) {
        ...
        if (success) {
            ...
            try {
                ...
                Log.e(Main.class.getName(), "File not found");
            } catch (IOException e) {
                Log.e(Main.class.getName(), "IOException related to generating bitmap file");
            }
        } else {
    ...
    private void initPalette() {
        ...
        for (int i = 0; i < colorButtons.length; i++) {
            ...
            colorButtons[i].setOnLongClickListener(view -> {
                ...
                Intent i1 = new Intent(Main .this, ColorSelector.class);
